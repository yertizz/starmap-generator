...
echo Creating selective backup of Star Map project...
...
set "BACKUP_BASE_DIR=C:\Users\phili\E-DRIVE\$1 AnythingPOD\sandbox-maps\STARMAP-SOURCE_BACKUP"
...
REM Copy specific folders recursively
...
echo Copying assets\images folder...
REM Robocopy creates the target directory structure, no need for mkdir assets
robocopy "%SOURCE_DIR%\assets\images" "%TARGET_DIR%\assets\images" /E /XJ /R:2 /W:5
