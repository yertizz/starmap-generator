...
function ensurePolygonStatusEl(){
    try {
        ...
        status.style.cssText = 'margin:8px 0;padding:6px 10px;border:2px solid #c00;background:#fff5f5;color:#222;font-weight:700;text-align:center;border-radius:4px;';
...
function setPolygonStatusDiag(base){
    try {
        ...
        const msg = `${base}; Overlays: rect=${rectOn? 'on':'off'}, poly=${polyOn? 'on':'off'}, points=${points}`;
