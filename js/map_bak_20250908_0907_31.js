    ...
    try {
        ...
        geocoderInstance.geocode({ address: zipText }, function(results, status) {
            if (status === 'OK' && results && results[0]) {
                ...
                // Draw immediate rectangle fallback from bounds/viewport or default around lat/lng
                try {
                    ...
                    if (b) {
                        ...
                        const d = 0.02; // ~small box if no bounds provided
                    ...
                    setPolygonStatus('Showing rectangle (initial)');
                ...
                (async function(){
                        ...
                        if (resp.ok) {
                            ...
                            if (gj && gj.type === 'Feature' && gj.geometry && Array.isArray(gj.geometry.coordinates)) {
                                ...
                                if (pathsArr.length) {
                                    ...
                                    try { if (gj.properties && gj.properties.source) setPolygonStatus('Polygon source: ' + gj.properties.source); else setPolygonStatus('Polygon drawn'); } catch(_){}
                                    return;
                                }
                            }
                        }
                    ...
                    try {
                        ...
                        setPolygonStatus('Using rectangle fallback');
                    } catch(_){ }
                })();
                // Save to history
