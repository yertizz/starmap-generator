        ...
        try {
            ...
            if (originalViewStarStreetLandscape) {
                window.viewStarStreetLandscape = function() {
                    ...
                    // Fix dimensions and positioning immediately and after delays
                    ...
                    // Update circle overlap
                    setTimeout(updateCircleOverlap, 500);
                    setTimeout(updateCircleOverlap, 1000);
                };
            }
...
/* END OF CODE - Cline - 2025-06-02 12:30 File: js/dimensions-fix-v2.js */