/* START OF CODE - Cline - 2025-06-03 19:17 File: js/combined-view-exact-match.js */
...
(function() {
    ...
    function fixCombinedViewLayout() {
        ...
        combinedViewSection.innerHTML = `
            <!-- Top horizontal line -->
            <div style="width: 100%; height: 1px; background-color: #ddd; margin-bottom: 15px;"></div>
            
            <!-- Combined View Options title -->
            ...
            <div style="width: 100%; height: 1px; background-color: #ddd; margin: 15px 0;"></div>
            
            <!-- Map Order row - CENTERED -->
            <div style="display: flex; justify-content: center; align-items: center; width: 100%; margin: 20px 0;">
                <div style="display: flex; align-items: center; justify-content: center; width: 80%;">
                    <label style="min-width: 120px; color: #666;">Map Order:</label>
            ...
            <!-- Note text - CENTERED -->
            <div style="width: 100%; text-align: center; font-size: 11px; color: #666; font-style: italic; margin-top: 15px;">
                These settings apply to Combined [Landscape] & Combined [Portrait] views ONLY!
            </div>
            
            <!-- Bottom horizontal line -->
            <div style="width: 100%; height: 1px; background-color: #ddd; margin-top: 15px;"></div>
        `;
...
/* END OF CODE - Cline - 2025-06-03 19:17 File: js/combined-view-exact-match.js */
