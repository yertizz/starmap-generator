...
(function() {
    ...
    function fixCombinedViewSpacingToMatchMockup() {
        ...
        const container = combinedRow.querySelector('div[style*="background-color"]');
        if (container) {
            // ULTRA TIGHT spacing + THICK CONSPICUOUS BORDERS like Star Map Canvas section
            container.style.cssText = `
                width: 100% !important;
    ...
    // 10. SAFE CONTAINER LAYOUT FIX - MOVE CONTAINERS 3,4,5 INSIDE WHITE FORM PAGE
    ...
    function initialize() {
        ...
        console.log('✓ All fixes applied including Settings + Preview + Download styling');
