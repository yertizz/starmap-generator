...
(function() {
    console.log('Dimensions Fix v2 - DISABLED TO PREVENT INTERFERENCE');
    ...
    function fixPortraitViewDimensions() {
        try {
            ...
            // Force portrait aspect ratio through CSS - CRITICAL FIX
            const aspectRatio = width / height;
            canvas.style.aspectRatio = `${width} / ${height}`;
            
            // Force portrait canvas to display correctly (taller than wide)
            if (height > width) {
                canvas.style.width = `${Math.min(400, width * 0.4)}px`;
                canvas.style.height = 'auto';
            }
...
/* ========================================================================== */
    ...
    function hookIntoViewFunctions() {
        try {
            ...
            // Combined Landscape view - DO NOT INTERCEPT - LET IT RUN COMPLETELY INDEPENDENTLY
            // NO HOOKING - The simplified functions handle everything themselves
            
            // Combined Portrait view - DO NOT INTERCEPT - LET IT RUN COMPLETELY INDEPENDENTLY  
            // NO HOOKING - The simplified functions handle everything themselves
...
/* END OF CODE - Cline - 2025-06-20 12:53 File: js/dimensions-fix-v2.js */
