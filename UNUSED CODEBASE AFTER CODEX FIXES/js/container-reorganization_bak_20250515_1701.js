/* START OF CODE - Cline - 2025-05-15 16:49:00 File: js/container-reorganization.js */
...
function initPaperSizeAndDPI() {
    ...
    function calculateDimensions() {
        ...
        // FIXED: Calculate the maximum circle diameter that can fit within the paper dimensions
        // For a perfect circle, we need to use the smaller dimension (width or height)
        const smallerDimension = Math.min(widthInPixels, heightInPixels);
        
        // Calculate the circle diameter based on the circle radius percentage
        ...
        const widthPadding = Math.round((widthInPixels - circleDiameter) / 2);
        const heightPadding = Math.round((heightInPixels - circleDiameter) / 2);
        ...
        console.log(`Circle diameter: ${circleDiameter} pixels (${circleRadiusPercent}% of ${smallerDimension})`);
    ...
    // Store the calculateDimensions function on the window object for access from other scripts
...
function addDimensionChangeListeners() {
    ...
    function updateDimensions(changedInput) {
        if (!aspectRatioCheckbox.checked) {
            return; // Don't enforce aspect ratio if checkbox is unchecked
        }
        ...
        console.log(`Updated dimensions: ${width}x${height} pixels`);
        console.log(`Circle diameter: ${circleDiameter} pixels (${circleRadiusPercent}% of ${smallerDimension})`);
        console.log(`Padding: ${widthPadding}px horizontal, ${heightPadding}px vertical`);
...
function addCircleRadiusListener() {
    ...
    circleRadiusInput.addEventListener('change', function() {
        ...
        const width = parseFloat(widthInput.value);
        const height = parseFloat(heightInput.value);
        const circleRadiusPercent = parseInt(this.value);
        ...
        console.log(`Circle radius changed to ${circleRadiusPercent}%`);
        console.log(`Circle diameter: ${circleDiameter} pixels (${circleRadiusPercent}% of ${smallerDimension})`);
        console.log(`Padding: ${widthPadding}px horizontal, ${heightPadding}px vertical`);
...
/* END OF CODE - Cline - 2025-05-15 16:49:00 File: js/container-reorganization.js */
