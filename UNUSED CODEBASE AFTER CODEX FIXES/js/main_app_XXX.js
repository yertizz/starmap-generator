/* START OF CODE - Cline - 2025-04-22 21:15 File: js/main_app.js */ // Updated timestamp
...
// --- FIXED: Google Maps API Callback Function ---
function initMap() {
    ...
    // Call the map initialization function from map.js
    if (typeof initializeGoogleMap === 'function') {
        initializeGoogleMap();
        console.log("Map initialization completed.");
    } else {
        console.error("CRITICAL: initializeGoogleMap function (from map.js) not found!");
    }
}

// Make initMap globally available for the Google Maps API callback
window.initMap = initMap;
// --- END FIXED: Google Maps API Callback Function ---
...
/* END OF CODE - Cline - 2025-04-22 10:47 File: js/main_app.js */