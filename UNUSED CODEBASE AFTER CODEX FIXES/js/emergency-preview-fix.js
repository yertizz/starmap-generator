// Emergency Preview Fix - Direct implementation to ensure the PREVIEW button works

document.addEventListener('DOMContentLoaded', function() {
    console.log("Emergency Preview Fix loaded");
    ...
    generateBtn.addEventListener('click', function() {
        console.log("Generate button clicked - Emergency Fix");
        generateStarMapDirect();
    });
    
    // Auto-trigger the generate function on page load
    setTimeout(function() {
        console.log("Auto-triggering generate button click - Emergency Fix");
        generateStarMapDirect();
    }, 1000);
    
    // Direct implementation of star map generation
    function generateStarMapDirect() {
        console.log("Generating star map directly");
    ...
    console.log("Emergency Preview Fix applied");
});

// Make the function globally available
window.generateStarMapDirect = function() {
    // This function will be called by the event listener
    console.log("generateStarMapDirect called from global scope");
