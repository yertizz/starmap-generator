/* START OF CODE - Cline - 2025-05-15 17:13:00 File: js/container-reorganization.js */
...
function initPaperSizeAndDPI() {
    ...
    // NEW: Function to apply CSS to ensure the star map is displayed as a perfect circle
    function applyCircleCSS() {
        ...
        console.log(`Applied CSS to ensure star map is displayed as a perfect circle`);
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        // Calculate the circle dimensions based on the current width, height, and circle radius
        if (typeof window.calculateCircleDimensions === 'function') {
            window.calculateCircleDimensions();
        }
...
/* END OF CODE - Cline - 2025-05-15 17:13:00 File: js/container-reorganization.js */
