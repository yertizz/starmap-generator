/* START OF CODE - Cline - 2025-05-15 20:01:00 File: js/container-reorganization-v2.js */
    ...
    if (!dateRow || !latLongRow) {
        ...
        fixedLayersSection.innerHTML = `
            <div class="row" style="display: flex; align-items: center; margin-bottom: 10px;">
                ...
                <select style="width: 60px; margin-right: 10px;">
                    <option>8</option>
                </select>
...
/* END OF CODE - Cline - 2025-05-15 20:01:00 File: js/container-reorganization-v2.js */
