...
function viewStarStreetLandscape() {
    ...
    // Remove title text to avoid black text overlay
...
function initializeCanvasForCombinedView() {
    ...
    try {
        ...
        // ALWAYS set canvas dimensions properly for combined views
        ...
        // FORCE set canvas dimensions for combined views
        canvas.width = width;
        ...
        console.log(`✅ Canvas FORCED to dimensions: ${width}w x ${height}h`);
...
/* END OF CODE - Cline - 2025-06-22 2:30 pm File: js/settings-preview-download.js */
