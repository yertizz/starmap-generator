// Final Working Fix - Comprehensive fix for all issues
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fixPreviewButton() {
        ...
        newBtn.addEventListener('click', function(e) {
            e.preventDefault();
            e.stopPropagation();
            console.log("Generate button clicked - Final Working Fix");
            generateStarMapFinal();
            return false;
        });
        
        // Auto-trigger the generate function on page load
        setTimeout(function() {
            console.log("Auto-triggering generate button click - Final Working Fix");
            generateStarMapFinal();
        }, 1000);
    }
    
    // Function to generate the star map
    function generateStarMapFinal() {
        console.log("Generating star map with Final Working Fix");
    ...
    function fixAdvancedOptions() {
        ...
        if (!advancedOptionsBtn) {
            console.log("Advanced Options button not found, creating it");
            ...
            const newAdvancedOptionsBtn = document.createElement('button');
            newAdvancedOptionsBtn.type = 'button';
            newAdvancedOptionsBtn.id = 'advanced-options-btn';
            newAdvancedOptionsBtn.textContent = 'Advanced Options';
            newAdvancedOptionsBtn.className = 'settings-button';
            newAdvancedOptionsBtn.style.marginTop = '10px';
            newAdvancedOptionsBtn.style.backgroundColor = '#2196F3';
            
            // Append button to the parent container
            parentContainer.appendChild(newAdvancedOptionsBtn);
            
            // Add event listener to the button
            newAdvancedOptionsBtn.addEventListener('click', function() {
...
window.generateStarMapFinal = function() {
    console.log("generateStarMapFinal called from global scope");
