/* START OF CODE - Cline - 2025-05-15 17:39:00 File: js/container-reorganization.js */
 ...
 * 4. FIXED: Ensures star map is always displayed as a perfect circle
 * 5. FIXED: Properly handles manually entered dimensions
 * 6. FIXED: Sets default dimensions to 2550 x 3300 with DPI of 300
 * 7. FIXED: Ensures aspect ratio checkbox is unchecked by default
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // FIXED: Set default dimensions to 2550 x 3300 with DPI of 300
    ...
    // FIXED: Ensure the star map is displayed as a perfect circle
    setTimeout(function() {
...
/**
 * NEW: Set default dimensions to 2550 x 3300 with DPI of 300
 */
function setDefaultDimensions() {
    ...
    // Set default dimensions to 2550 x 3300
...
function initPaperSizeAndDPI() {
    ...
    function calculateDimensions() {
        ...
        // FIXED: Do NOT force the aspect ratio checkbox to be checked
    ...
    function calculateCircleDimensions() {
        ...
        // FIXED: Always use the smaller dimension to ensure a perfect circle
    ...
    // COMPLETELY REWRITTEN: Function to apply CSS to ensure the star map is displayed as a perfect circle
    function applyCircleCSS() {
        ...
        // FIXED: Apply CSS to ensure the star map is displayed as a perfect circle
        ...
        // FIXED: Ensure the canvas container has enough space for the circle
        if (canvasContainer) {
...
function fixAdvancedOptionsPanel() {
    ...
    if (cancelButton) {
        // Remove any existing event listeners by cloning and replacing
        const newCancelButton = cancelButton.cloneNode(
