...
function initializeButtons() {
    ...
    // Just connect them to the new button IDs
...
function viewStarMap() {
    ...
    // Create the star map URL
    const apiUrl = `https://api.astronomyapi.com/api/v2/studio/star-chart?lat=${latitude}&lon=${longitude}&date=${date}&style=${starMapStyle}`;
...
function viewStarMapOnCanvas() {
    ...
    if (typeof viewStarMapOnCanvasExisting === 'function') {
        viewStarMapOnCanvasExisting();
    } else {
