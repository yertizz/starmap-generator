...
function viewStarMap() {
    ...
    console.log("Loading star map image from:", img.src);
...
function viewStreetMap() {
    ...
    // Set a placeholder image for now (since we don't have actual Google Maps API access)
    // In a real implementation, this would be the Google Maps Static API URL
    img.src = "https://via.placeholder.com/800x800/FFFFFF/000000?text=Street+Map";
    console.log("Loading street map image from:", img.src);
    
    // If the image fails to load, restore the context to avoid clipping issues
    img.onerror = function() {
        console.error("Failed to load street map image");
        ctx.restore();
...
function viewStarStreetLandscape() {
    ...
    // Set placeholder images for now
    streetMapImg.src = "https://via.placeholder.com/800x800/FFFFFF/000000?text=Street+Map";
    starMapImg.src = "https://via.placeholder.com/800x800/000033/FFFFFF?text=Star+Map";
    console.log("Loading street and star map images for landscape view");
    
    // Error handlers for both images
    streetMapImg.onerror = function() {
        console.error("Failed to load street map image for landscape view");
        // Draw a fallback street map (white circle with red marker)
        ctx.save();
        ctx.beginPath();
        ctx.arc(leftCenterX, centerY, radius, 0, Math.PI * 2, true);
    ...
    starMapImg.onerror = function() {
        console.error("Failed to load star map image for landscape view");
...
function viewStarStreetPortrait() {
    ...
    streetMapImg.src = "https://via.placeholder.com/800x800/FFFFFF/000000?text=Street+Map";
    starMapImg.src = "https://via.placeholder.com/800x800/000033/FFFFFF?text=Star+Map";
    console.log("Loading street and star map images for portrait view");
    
    // Error handlers for both images
    streetMapImg.onerror = function() {
        console.error("Failed to load street map image for portrait view");
        // Draw a fallback street map (white circle with red marker)
        ctx.save();
        ctx.beginPath();
        ctx.arc(centerX, topCenterY, radius, 0, Math.PI * 2, true);
    ...
    starMapImg.onerror = function() {
        console.error("Failed to load star map image for portrait view");
        // Draw a fallback star map (navy blue circle)
        ctx.save();
        ctx.beginPath();
        ctx.arc(centerX, bottomCenterY, radius, 0, Math.PI * 2, true);
